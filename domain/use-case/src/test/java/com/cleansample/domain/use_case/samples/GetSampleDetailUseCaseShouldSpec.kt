...
import com.cleansample.domain.entity.*
...
class GetSampleDetailUseCaseShouldSpec : ShouldSpec() {
    ...
    init {
        ...
        should("get sample from repository on success result should return success result") {
            ...
            expectedResponse.getOrThrow() shouldBe result.getOrThrow()
        }

        should("get sample with error result should return error") {
            val fakeResult = WrappedResult.failure<SampleEntity>(Exception("Exception"))
